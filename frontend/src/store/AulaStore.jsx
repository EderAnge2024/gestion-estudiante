...
const useAulaStore = create((set)=>({
    ...
    addAula: async (aula) => {
        try {
            const response = await axios.post("http://localhost:3001/aula",aula)
    ...
    fetchAulas: async () =>{
        try {
            const response = await axios.get("http://localhost:3001/aula")
    ...
    deleteAula: async (id) => {
        try {
            const response = await axios.delete(`http://localhost:3001/aula/${id}`)
